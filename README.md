...
* **Impact Materiality (Inside-Out):** The organization's impact on people and the environment.
* **Financial Materiality (Outside-In):** Sustainability-related financial risks and opportunities affecting the organization's value.

Through advanced data visualization techniques, this dashboard converts static ESG spreadsheets into an interactive corporate decision-making tool.

---

## 📊 Dashboard Interactivity & Architecture
...
1. **Main Matrix (`image_2ddc38.png`):** Shows the consolidated Double Materiality perspective, mapping overall Impact vs. Financial scores.
2. **Impact Materiality Perspective (`image_2ddc01.png`):** Focuses on the granularity of Scale vs. Scope.
